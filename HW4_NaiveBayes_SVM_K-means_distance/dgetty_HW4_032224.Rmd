...
PStatus_Senior = (senior_total / sum_total)

print("P(Staus = Senior)",round(PStatus_Senior,2))

PStatus_Junior = (junior_total / sum_total)

print("P(Staus = Junior)",round(PStatus_Junior,2))
...
PStatus_Senior_x = (PDept_Systems * PAge_26_30 * PSalary_46K_50K * PStatus_Senior * PStatus_Senior)
...
PStatus_Junior_x = (PDept_Systems * PAge_26_30 * PSalary_46K_50K * PStatus_Junior * PStatus_Junior)
...
# assign memberships using manhattan distance
